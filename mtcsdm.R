# Title: A Monetary Two-Country Structural Dynamic Model (v0.0.1)
# Author: LI Wu. 2019, 12.
...
library(CGE)
mtcsdm <- function(._labor.supply.CHN = 50, ._labor.supply.ROW = 200,
                   ._stock.supply.CHN = 30, ._stock.supply.ROW = 120,
                   ._tax.receipt.supply.CHN = 20, ._tax.receipt.supply.ROW = 80,
                   ._bond.supply.CHN = 2, ._bond.supply.ROW = 8,
                   ...
                   ._alpha.industry.CHN = 20, ._alpha.industry.ROW = 10,
                   ...
                   ._industry.ratio_tax_labor.CHN = 0.2, ._industry.ratio_tax_labor.ROW = 0.2,
                   ._industry.ratio_dividend_labor.CHN = 0.2, ._industry.ratio_dividend_labor.ROW = 0.2,

                   ._sigma.consumer.CHN = -0.1, ._sigma.consumer.ROW = -0.1,
                   ._alpha.consumer.CHN = 20, ._alpha.consumer.ROW = 10,
                   ._beta.consumer.domestic.product.CHN = 0.3, ._beta.consumer.domestic.product.ROW = 0.6,
                   ._beta.consumer.imported.product.CHN = 0.7, ._beta.consumer.imported.product.ROW = 0.4,

                   ._domestic.investment.rate.CHN = 0.7, ._domestic.investment.rate.ROW = 0.8,

                   ._tax.rate.CHN_ROW = 0.1, ._tax.rate.ROW_CHN = 0.05) {
  account.zero <- c(
  ...
  A.pre <- function(state) {
    ...
    tmp.investment.bundle <- CES_A(
      ._sigma.industry.CHN,
      1, rbind(._beta.industry.domestic.product.CHN, ._beta.industry.imported.product.CHN),
      p[c("product.CHN", "imported.product.CHN_ROW")]
    )
